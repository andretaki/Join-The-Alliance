  ...
  return [
    ...
    // Variation 3: Balanced candidate with B2B experience
    {
      ...
      roleAssessment: {
        ...
        restrictedChemicalScenario: 'I would first verify the customer\'s current certifications and licenses in our system. If their orders have increased significantly, I\'d review their business profile and contact them to understand their expanding needs. I would ensure they have proper storage certifications and updated safety protocols. If everything is in order, I\'d document the increased usage pattern. If there are any concerns, I\'d escalate to management and potentially contact regulatory authorities as required.',
        b2bLoyaltyFactor: 'reliability' as const,
